...
class Pandoc(object):
    ...
    def pandoc(self):
        pandoc_data = self.wf.stored_data('pandoc')
        if pandoc_data == None:
            data = {
                'path': self.path,
                ...
                'arg_options': self.arg_options
            }
            self.wf.store_data('pandoc', data, serializer='json')
            pandoc_data = data
        return pandoc_data
...
## Pandoc properties  ---------------------------------------------------------
    ...
    def outputs(self):
        ...
        """
        try:
            return self.me['outputs']
        except AttributeError:
            out_fmts = self._formats['outputs']
            return out_fmts
    ...
    def inputs(self):
        ...
        """
        try:
            return self.me['inputs']
        except AttributeError:
            in_fmts = self._formats['inputs']
            return in_fmts
    ...
    def arg_options(self):
        ...
        """
        try:
            return self.me['arg_options']
        except AttributeError:
            return self._arg_option_flags()
